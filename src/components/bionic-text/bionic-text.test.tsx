...
describe('BionicText component', () => {
  const testCases = [
    ...
    { text: '', words: [] },
    { text: '  leading and trailing spaces  ', words: ['leading', 'and', 'trailing', 'spaces'] },
    { text: 'multiple   spaces', words: ['multiple', 'spaces'] },
    { text: 'punctuation, and. special! characters?', words: ['punctuation,', 'and.', 'special!', 'characters?'] },
  ];
  ...
  it('applies custom styles', () => {
    const { container } = render(<BionicText text="Styled Text" style={{ color: 'red' }} />);
